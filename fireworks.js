...
function lerp(start, end, t) { //Linear interpolation (decelerates firework)
    return start * (1-t) + end * t;
}

function buildHsla(color, alpha) { //Allows for alpha value to be modified
